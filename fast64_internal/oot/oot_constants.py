...
ootEnumTransitionActorID = [actor for actor in ootEnumActorID if 'Door' in actor[1] or 'Holl' in actor[1]]
...
ootEnumGlobalObject = [obj for obj in ootEnumObjectID if 'keep' in obj[1]]
