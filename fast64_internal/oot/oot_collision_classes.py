...
ootEnumCollisionSound = [
    ("Custom", "Custom", "Custom"),
    ("0x00", "Dirt", "SURFACE_MATERIAL_DIRT"),
    ("0x01", "Sand", "SURFACE_MATERIAL_SAND"),
    ("0x02", "Stone", "SURFACE_MATERIAL_STONE"),
    ("0x03", "Wet Stone", "SURFACE_MATERIAL_JABU"),
    ("0x04", "Shallow Water", "SURFACE_MATERIAL_WATER_SHALLOW"),
    ("0x05", "Water", "SURFACE_MATERIAL_WATER_DEEP"),
    ("0x06", "Tall Grass", "SURFACE_MATERIAL_TALL_GRASS"),
    ("0x07", "Lava/Goo", "SURFACE_MATERIAL_LAVA"),
    ("0x08", "Grass", "SURFACE_MATERIAL_GRASS"),
    ("0x09", "Wooden Plank", "SURFACE_MATERIAL_BRIDGE"),
    ("0x0A", "Packed Earth/Wood", "SURFACE_MATERIAL_WOOD"),
    ("0x0B", "Soft Dirt", "SURFACE_MATERIAL_DIRT_SOFT"),
    ("0x0C", "Ceramic/Ice", "SURFACE_MATERIAL_ICE"),
    ("0x0D", "Carpet", "SURFACE_MATERIAL_CARPET"),
]
